...
Final Assignment for Coursera's Getting and Cleaning Data course
...
- Download and unzip source data if it doesn't exist. Read data. 
- Merge the training and the test sets to create one data set. -Extract only the measurements on the mean and standard deviation for each measurement. 
...
- The tidy_data.txt in this repository was created by running the run_analysis.R script using R version 4.0.2 (2020-10-10) 
